...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Ruta a un archivo de texto/markdown con el requerimiento (opcional).",
    )
    parser.add_argument(
        "--temperature",
        type=float,
...
def main():
    ...
    if args.requirement:
        requirement_text = args.requirement if requirement_text is None else requirement_text
    ...
    if requirement_text:
        ...
        code = generator.generate_code(requirement_text)
        print("\n=== Fragmento generado ===\n")
        print(code)

    if not args.ingest and not requirement_text:
        print(
